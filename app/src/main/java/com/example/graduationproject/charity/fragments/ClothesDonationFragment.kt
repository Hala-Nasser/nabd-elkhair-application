...
class ClothesDonationFragment : Fragment(), CampaignsAdapter.onCampaignItemClickListener {
    ...
    override fun onCreateView(
        ...
        campaignsList.add(Campaigns(R.drawable.campaign_image,"تقديم الملابس للعائلات المحتاجة","22/2/2022"
        ...
        if (activity!!::class.java.name == DonorMainActivity::class.java.name){
            root.rv_clothes_donation.layoutManager = LinearLayoutManager(activity,
