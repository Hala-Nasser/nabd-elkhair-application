...
class NotificationAdapter(var activity: Context?, var data :List<Notification>) : RecyclerView.Adapter<NotificationAdapter.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotificationAdapter.MyViewHolder {
        var View: View = LayoutInflater.from(activity).inflate(R.layout.donor_notification_item ,parent ,false)
